...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"leaflet.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("\n        /api/v1/bookings/checkout-session/".concat(tourId, "?startDate=").concat(encodeURIComponent(startDate)));
        case 1:
          session = _context.v;
          _context.n = 2;
...
if (overlay) {
  overlay.addEventListener('click', function () {
    document.querySelectorAll('.nav').forEach(function (nav) {
      return nav.classList.remove('nav--open');
    });
        ...
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.p = _context2.n) {
              case 0:
                e.preventDefault();
                action = e.submitter.getAttribute('name') === 'action' ? e.submitter.value : null; //console.log(action);
                ...
                if (action === 'save') {
                  ...
                  userId = _userInput === null || _userInput === void 0 ? void 0 : _userInput.value; // console.log(`Form ${index + 1} - Submitting review:`, {
                  //   rating,
                  //   review,
                  //   tourId,
                  //   userId,
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
              userId = userInput === null || userInput === void 0 ? void 0 : userInput.value; // console.log(`Form ${index + 1} - Submitting review:`, {
              //   rating,
              //  review,
              //  tourId,
              // userId,
