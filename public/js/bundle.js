...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You are now logged out !');
            window.setTimeout(function () {
              location.assign('/login');
            }, 2500);
          }
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.log('TO ERROR : ', _t2.response);
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "A Link to a new password has sent to the given email : ".concat(email));
          }
          _context.n = 3;
          break;
        case 2:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51S0jvlB2bpLGEFECW1ZqZ8uBkhceDAl18HgDnfRLQvwVvLicFnv1wzRl5xdtmXW4knyTcuLdPQzdUH0XTzgZvdNG00AwsS4q9m');
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId, startDate) {
    var session, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("\n        http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId, "?startDate=").concat(encodeURIComponent(startDate)));
        case 1:
          session = _context.v;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"rating.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateRating = exports.ratingJS = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var ratingJS = exports.ratingJS = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(rating, review, tour, user) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your rating have been submited , Thanks for making A review !');
            window.setTimeout(function () {
  ...
  return function ratingJS(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
var updateRating = exports.updateRating = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(reviewId, rating, review) {
    var res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your rating has changed , Thanks for making a review ');
          }
          _context2.n = 3;
          break;
        case 2:
  ...
  return function updateRating(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
// });
var toggleBtn = document.querySelector('.nav__toggle-btn');
...
if (dateForm) {
  ...
  var select = dateForm.querySelector('select[name="startDate"]');
  var tourInput = dateForm.querySelector('#tour');
  var userInput = dateForm.querySelector('#user');
  select.addEventListener('change', function () {
    var startDate = select.value;
    var tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
    var userId = userInput === null || userInput === void 0 ? void 0 : userInput.value;
    console.log("Selected Date: ".concat(startDate, " for tour: ").concat(tourId, " and user: ").concat(userId));
  });
  dateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var startDate, tourId, userId, currentDate, selectedDate;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            e.preventDefault();
            startDate = select.value;
            tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
            userId = userInput === null || userInput === void 0 ? void 0 : userInput.value;
            if (!(!startDate || !tourId || !userId)) {
              _context.n = 1;
              break;
            }
            (0, _alerts.showAlert)('error', 'Please select a start date and ensure tour and user IDs are provided');
            return _context.a(2);
          case 1:
            ...
            (0, _alerts.showAlert)('error', 'I am sorry this date is expired !');
            return _context.a(2);
          case 2:
...
document.addEventListener('DOMContentLoaded', function () {
  var editRating = document.querySelectorAll('.edit-review-form');
  console.log('EditRating forms found:', editRating.length, editRating); // Debug: Δείχνει πόσα forms βρέθηκαν

  if (editRating.length > 0) {
    editRating.forEach(function (form, index) {
      var inputs = form.querySelectorAll('.rating__input'); // Διορθώθηκε το selector
      console.log("Form ".concat(index, " found ").concat(inputs.length, " rating inputs"), inputs);
      inputs.forEach(function (input, inputindex) {
        input.addEventListener('change', function () {
          var tourInput = form.querySelector('input[name="tour"]');
          var userInput = form.querySelector('input[name="user"]');
          var tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
          var userId = userInput === null || userInput === void 0 ? void 0 : userInput.value;
          console.log("Form ".concat(index, " - Selected Star : ").concat(input.value, ", tourInput:"), tourInput, "userInput", userInput);
        });
      });
      form.addEventListener('submit', /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
          var _form$querySelector;
          var action, rating, _form$querySelector2, review, _tourInput, _userInput, reviewInput, reviewId, tourId, userId, _reviewId, _err$response, _t;
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.p = _context2.n) {
              case 0:
                e.preventDefault();
                action = e.submitter.getAttribute('name') === 'action' ? e.submitter.value : null;
                console.log(action);
                rating = (_form$querySelector = form.querySelector('input[name="rating"]:checked')) === null || _form$querySelector === void 0 ? void 0 : _form$querySelector.value;
                if (action === 'save') {
                  review = (_form$querySelector2 = form.querySelector('textarea[name="review"]')) === null || _form$querySelector2 === void 0 ? void 0 : _form$querySelector2.value;
                  _tourInput = form.querySelector('input[name="tour"]');
                  _userInput = form.querySelector('input[name="user"]');
                  reviewInput = form.querySelector('input[name="review"]');
                  reviewId = reviewInput === null || reviewInput === void 0 ? void 0 : reviewInput.value;
                  tourId = _tourInput === null || _tourInput === void 0 ? void 0 : _tourInput.value;
                  userId = _userInput === null || _userInput === void 0 ? void 0 : _userInput.value;
                  console.log("Form ".concat(index + 1, " - Submitting review:"), {
                    rating: rating,
                    review: review,
                    tourId: tourId,
                    userId: userId,
                  ...
                  (0, _rating.updateRating)(reviewId, rating, review);
                }
                if (!(action === 'delete')) {
                  _context2.n = 4;
                  break;
                ...
                _reviewId = e.submitter.dataset.reviewId; // const button = e.target.closest('.btn--delete-review'); // Ελέγχει μόνο για .btn--delete-review
                // if (button) {
                //   const reviewId = button.dataset.reviewId;
                console.log('button checked, REVIEWID:', _reviewId);
                ...
                return (0, _axios.default)({
                  method: 'DELETE',
                  url: "/api/v1/reviews/".concat(_reviewId)
                });
              case 2:
              ...
              case 3:
                _context2.p = 3;
                _t = _context2.v;
                console.error('Delete error:', _t);
                (0, _alerts.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Failed to delete review');
              case 4:
                return _context2.a(2);
            }
          }, _callee2, null, [[1, 3]]);
...
if (ratingForm.length > 0) {
  ...
  ratingForm.forEach(function (form, index) {
    console.log("Processing form ".concat(index + 1, ":"), form);
    var inputs = form.querySelectorAll('.rating__input');
    console.log("Form ".concat(index + 1, " - Found ").concat(inputs.length, " radio inputs"));
    inputs.forEach(function (input, inputIndex) {
      input.addEventListener('change', function () {
        var tourInput = form.querySelector('input[name="tour"]');
        var userInput = form.querySelector('input[name="user"]');
        var tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
        var userId = userInput === null || userInput === void 0 ? void 0 : userInput.value;
        console.log("Form ".concat(index + 1, " - Selected star: ").concat(input.value, ", tourInput:"), tourInput, "userInput:", userInput);
        console.log("Form ".concat(index + 1, " - Selected star: ").concat(input.value, " for tour: ").concat(tourId, " for user: ").concat(userId));
      });
    });
    form.addEventListener('submit', /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(e) {
        var _form$querySelector3, _form$querySelector4;
        var rating, review, tourInput, userInput, tourId, userId;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              e.preventDefault();
              rating = (_form$querySelector3 = form.querySelector('input[name="rating"]:checked')) === null || _form$querySelector3 === void 0 ? void 0 : _form$querySelector3.value;
              review = (_form$querySelector4 = form.querySelector('textarea[name="review"]')) === null || _form$querySelector4 === void 0 ? void 0 : _form$querySelector4.value;
              tourInput = form.querySelector('input[name="tour"]');
              userInput = form.querySelector('input[name="user"]');
              tourId = tourInput === null || tourInput === void 0 ? void 0 : tourInput.value;
              userId = userInput === null || userInput === void 0 ? void 0 : userInput.value;
              console.log("Form ".concat(index + 1, " - Submitting review:"), {
                rating: rating,
              ...
              console.log("Form ".concat(index + 1, " - Inputs:"), {
                tourInput: tourInput,
                userInput: userInput
              });
              if (rating) {
              ...
              (0, _alerts.showAlert)('error', 'Please select a rating');
              return _context3.a(2);
            case 1:
              if (!(!tourId || !userId)) {
                _context3.n = 2;
              ...
              (0, _alerts.showAlert)('error', 'Tour ID or User ID missing');
              return _context3.a(2);
            case 2:
              _context3.n = 3;
              return (0, _rating.ratingJS)(rating, review, tourId, userId);
            case 3:
              return _context3.a(2);
          }
        }, _callee3);
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _step$value = _slicedToArray(_step.value, 2),
          key = _step$value[0],
          value = _step$value[1];
        console.log("".concat(key, ": ").concat(value instanceof File ? value.name : value));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
if (calendarEl) {
  ...
  var tour = tourDataElement ? JSON.parse(tourDataElement.textContent) : {};
  ...
  var events = tour.startDates && tour.duration ? tour.startDates.map(function (startDate, index) {
    ...
    return {
      title: "".concat(tour.name || 'Athens Urban Explorer', " (Tour ").concat(index + 1, ")"),
      start: start,
      end: end,
      allDay: true,
      backgroundColor: '#3586dcff',
      // Blue background
      borderColor: '#3586dcff',
      // Blue border
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var passwordRegex = /^(?=.*[A-Z]).{8,50}$/;
    if (!passwordRegex.test(password)) {
      (0, _alerts.showAlert)('error', 'Password must contain at least 8 characters and one uppercase letter');
      return;
    }
...
if (resetPassword) {
  resetPassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(e) {
      var password, passwordConfirm, token, baseURL, res, data, _t2;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          case 0:
            ...
            _context4.n = 2;
            return fetch("".concat(baseURL, "/api/v1/users/resetPassword/").concat(token), {
              method: 'PATCH',
              headers: {
                'Content-Type': 'application/json'
              },
          ...
          case 3:
            ...
            if (data.status === 'success') {
              ...
              (0, _alerts.showAlert)('error', data.message || 'Error resetting password');
            }
            _context4.n = 5;
            break;
          case 4:
            _context4.p = 4;
            _t2 = _context4.v;
            console.error('Error:', _t2); // Debug: Log the error
            (0, _alerts.showAlert)('error', 'Could not connect to server');
          case 5:
...
if (sidebarLinks) {
  ...
  sidebarLinks.forEach(function (link) {
    link.addEventListener('click', function (e) {
      e.preventDefault();
      var view = link.dataset.view; // Χρησιμοποιούμε data-view αντί για id
      console.log('Selected view:', view);

      // Remove active class from all links
      sidebarLinks.forEach(function (l) {
        return l.parentElement.classList.remove('side-nav--active');
      });
      // Add active class to clicked link
      link.parentElement.classList.add('side-nav--active');
